...
def inline_pdf(filename):
    ...
    #upload_dir = os.path.join(os.getcwd(), 'uploads')
    upload_dir=r"C:\Railway\git\uploads"
    pdf_path = os.path.join(upload_dir, filename)
    if not os.path.exists(pdf_path):
        flash('❌ PDF file not found')
        return redirect(url_for('main.approval_tracking'))
...
def download():
    ...
    try:
        ...
        download_dir = r"C:\Railway\git\xlsx_download" 
        upload_dir = r"C:\Railway\git\uploads" 
        ...
        try:
            ...
            #converter_script = "/var/www/html/git/excel_to_pdf_converter.py"
            converter_script = r"C:\Railway\git\excel_to_pdf_converter.py"
...
def download_ctr_sample_template():
    ...
    try:
        ...
        return send_file(
            "/var/www/html/git/CTR_Sample_Template.xlsx",
            as_attachment=True,
...
def upload_ctr_xlsx():
    ...
    try:
        ...
        BASE_DIR = converter_script = r"C:\Railway\git\Circuitbuilding" 
...
def view_ctr_pdf(upload_id):
    ...
    try:
        ...
        pdf_folder = r"C:\Railway\git\Circuitbuilding\uploads_ctr"
